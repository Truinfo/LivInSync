...
const { createSequrity, updateSequrityProfile, getSequritiesBySocietyId, deleteSequrityProfilePicture, getGuardBySocietyIdAndId, sequirtySignin, getSequrityBySocietyIdAndsequrityId, getAttendanceOfSequrityId, checkAttendanceStatus, addCheckIn, addCheckOut, } = require('../../controllers/Authentication/Security');
...
router.post('/sequrity/checkAttendanceStatus/:sequrityId', checkAttendanceStatus);
